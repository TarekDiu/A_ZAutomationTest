...
public class Base {
	...
	@BeforeMethod
	  ...
	  properties = new Properties(); try { fileinputstream = new
	  FileInputStream("./src/main/resources/properties/acd.properties"); }catch
	  (FileNotFoundException e) { e.printStackTrace(); } try {
	  properties.load(fileinputstream); }catch(IOException e) {
	  e.printStackTrace(); } }
